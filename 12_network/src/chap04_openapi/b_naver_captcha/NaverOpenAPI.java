...
public class NaverOpenAPI {
		...
		/**
		 * 캡파 키 요청 후 발급 받은 캡차 키를 반환하는 메소드
		 * @return 네이버로부터 발급 받은 캡차 키
		 */
		public static String captchaKey() throws Exception {
		
			// ---- 요청
			String apiURL = "https://openapi.naver.com/v1/captcha/nkey?code=0";  // ---- code=0 부분은 캡차 키 요청시 생략 가능 합니다.
		...
		public static boolean captchaImage(String key) throws Exception {
			...
			if (responseCode == 200) {
				...
				//  이 부븐은 BufferedReader/InputStreamReader/StringBuilder를 이용해서 에러 처리를 별도로 해 줘야 합니다.
