 ...
 * GSON
 * 
 * 1. google에서 개발한 java 기반의 오픈소스 라이브러리 입니다.
 * 2. JSON 데이터를 java 객체로 변환하거나 java 객체를 JSON형식으로 변환하는 라이브러리입니다.
 * 3. 직렬화 (Serialization)       : Java 객체 -> JSON 문자열, toJson() 메소드 활용
 * 4. 역직렬활 (Deserialization)   : JSON 문자열 -> Java 객체, fromJson() 메소드 활용
 */
